  ...
  <div class="side-setting">
    ...
    <setting-item :title="$t('theme.title')">
      ...
      >
        ...
        <img-checkbox :title="$t('theme.dark')" :img="all_dark" value="dark"/>
        <img-checkbox :title="$t('theme.light')" :img="all_light" value="light"/>
        <img-checkbox :title="$t('theme.night')" :img="all_night" value="night"/>
      </img-checkbox-group>
    </setting-item>
    ...
    <setting-item :title="$t('navigate.title')">
      ...
      >
        ...
        <img-checkbox :title="$t('navigate.side')" :img="nav_side" value="side"/>
        <img-checkbox :title="$t('navigate.head')" :img="nav_head" value="head"/>
        <img-checkbox :title="$t('navigate.mix')" :img="nav_mix" value="mix"/>
      </img-checkbox-group>
    </setting-item>
    <setting-item>
      <a-list :split="false">
...
export default {
  ...
  data() {
    return {
      ...
      all_dark: require("@/assets/img/all_dark.svg"),
      all_light: require("@/assets/img/all_light.svg"),
      all_night: require("@/assets/img/all_night.svg"),
      nav_side: require("@/assets/img/nav_side.svg"),
      nav_head: require("@/assets/img/nav_head.svg"),
      nav_mix: require("@/assets/img/nav_mix.svg"),
    }
  },
  computed: {
    directions() {
