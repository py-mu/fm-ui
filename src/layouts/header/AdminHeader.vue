  ...
  <a-layout-header :class="[headerTheme, 'admin-header']">
    <div :class="['admin-header-wide', layout, pageWidth]">
      ...
      <div :class="['admin-header-right', headerTheme]">
        ...
        <!--            <a href="http://127.0.0.1:8000/api/v1/swagger" target="_blank">-->
        <!--              <a-icon type="question-circle-o" />-->
        <!--            </a>-->
        <!--          </a-tooltip>-->
        <!--          <header-notice class="header-item"/>-->
        <header-avatar @showSetting="handlerSetting" class="header-item" :show-setting="getShowSetting"/>
...
export default {
  ...
  props: ['collapsed', 'menuData', 'showSetting'],
  data() {
    return {
      langList: [
